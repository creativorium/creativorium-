                    ...
                    <div className="row justify-content-center mil-up">
                        <div className="col-lg-4">
                            {AppData.settings.formspreeSubscriptionURL ? (
                                <form onSubmit={handleSubmit} className="mil-subscribe-form mil-subscribe-form-2 mil-up">
                                    <input 
                                        type="email" 
                                    ...
                                    {status && <p style={{marginTop: '10px', fontSize: '12px', color: status.includes('Thanks') ? '#4CAF50' : '#f44336'}}>{status}</p>}
                                </form>
                            ) : (
